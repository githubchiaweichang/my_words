...
intoxicate,使酒醉,使陶醉　　
在古希腊语“弓”叫toxon,希腊武士用来制毒箭的毒药叫toxikon,中世纪时拉丁语借用了该词,作toxicum,泛指任何毒药,intoxicate一词即源自该拉丁词的动词形式intoxicare,最初表示“使中毒”,中毒原因有多种,在某种意义上酒醉也是中毒,是酒精过量引起的中毒,据此,intoxicate逐渐转义为“使酒醉”,“使陶醉”,其过去分词形式intoxicated也随之成为drunk(酒醉的)众多的同义词中的一员,可是,另外两个出于同源的单词toxic(有毒的)和toxin(毒素)却仍然保留着原先的含义,
